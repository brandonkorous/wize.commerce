...
{
    public class OrderProductRepository : RepositoryBase<int, OrderProduct>, IOrderProductRepository
    {
        public OrderProductRepository(ILogger<IOrderProductRepository> logger, WizeContext context) : base(logger, context)
        {
