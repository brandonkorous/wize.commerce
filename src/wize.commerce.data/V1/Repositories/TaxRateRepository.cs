...
{
    public class TaxRateRepository : RepositoryBase<int, TaxRate>, ITaxRateRepository
    {
        public TaxRateRepository(ILogger<ITaxRateRepository> logger, WizeContext context) : base(logger, context)
        {
