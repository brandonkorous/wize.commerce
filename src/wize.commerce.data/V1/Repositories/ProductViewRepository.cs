...
{
    public class ProductViewRepository : RepositoryBase<int, ProductView>, IProductViewRepository
    {
        public ProductViewRepository(ILogger<IProductViewRepository> logger, WizeContext context) : base(logger, context)
        {
