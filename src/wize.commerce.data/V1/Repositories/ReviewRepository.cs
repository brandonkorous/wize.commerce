...
{
    public class ReviewRepository : RepositoryBase<int, Review>, IReviewRepository
    {
        public ReviewRepository(ILogger<IReviewRepository> logger, WizeContext context) : base(logger, context)
        {
