...
{
    public class InventoryModelConfiguation : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<Inventory> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<Inventory>("Inventories").EntityType;
            model.HasKey(m => m.InventoryId);
            return model;
        }
