...
{
    public class StateModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<State> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<State>("States").EntityType;
            model.HasKey(m => m.StateId);
            return model;
        }
