...
{
    public class UserOrdersModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<UserOrders> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<UserOrders>("UserOrders").EntityType;
            model.HasKey(m => m.UserId);
            return model;
        }
