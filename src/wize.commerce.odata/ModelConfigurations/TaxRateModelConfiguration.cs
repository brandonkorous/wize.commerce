...
{
    public class TaxRateModelConfiguration : IModelConfiguration
    {
        ...
        private EntityTypeConfiguration<TaxRate> BuildDefault(ODataModelBuilder builder)
        {
            var model = builder.EntitySet<TaxRate>("TaxRates").EntityType;
            model.HasKey(m => m.TaxRateId);
            return model;
        }
